...
namespace IrrKlangDriver{
    ...
    public class irrklangSound : iActiveSoundObject, ISoundStopEventReceiver
    {
        ...
        {
            get { return msoundobj.PlayPosition; }

        }
        public float Tempo
        {
            get { return msoundobj.PlaybackSpeed; }

            set { msoundobj.PlaybackSpeed = value; }
        ...
        {
            mfinished = true;
            ourdriver.RaiseOnSoundStop(this);
