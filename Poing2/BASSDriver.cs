...
namespace BASeBlock
{
    public class BASSSound : iSoundSourceObject, iActiveSoundObject,IDisposable 
    {
        ...
        public float Tempo
        {
            ...
            {
                float result = 0;
                Bass.BASS_ChannelGetAttribute(ActiveStream, BASSAttribute.BASS_ATTRIB_TEMPO, ref result);
                if (result == 0)
            ...
            set
            {
                ...
                Bass.BASS_ChannelSetAttribute(ActiveStream, BASSAttribute.BASS_ATTRIB_TEMPO, value);
                int CalculatedValue;
                CalculatedValue = BCBlockGameState.ClampValue((int)(value * 128), 0, 255);
    ...
    class BASSDriver : iSoundEngineDriver 
    {
        ...
        public BASSDriver(String pluginFolder)
        {
            ...
            String x86DLL = Path.Combine(BCBlockGameState.AppDataFolder, "Lib\\x86");
            String x64DLL = Path.Combine(BCBlockGameState.AppDataFolder, "Lib\\x64");
        ...
        public BASSDriver()
            : this(Path.Combine(BCBlockGameState.AppDataFolder,"SoundPlugin"))
        {
