...
namespace BASeCamp.BASeBlock
{
    ...
    public class LevelSet : ISerializable, IXmlPersistable
    {
        ...
        public XElement GetXmlData(String pNodeName,Object pPersistenceData)
        {
            ...
            LevelData.Add(StandardHelper.SaveList(Levels, "Levels",pPersistenceData));
            LevelData.Add(PathData.GetXmlData("PathData",pPersistenceData));
            return LevelData;
        }
        ...
        public LocalHighScores HighScores
        {
